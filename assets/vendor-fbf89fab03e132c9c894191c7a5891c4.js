...
do{if(r[t.id]){n&&(n===t||t.contains(n))||i(t,d(p,e))
break}if(t.hasAttribute("data-ember-action")){n&&(n===t||t.contains(n))||o(t,d(p,e))
break}t=t.parentNode}while(t&&1===t.nodeType)},e.addEventListener(u,f)):(h=this._eventHandlers[t]=function(e){var t=e.target
